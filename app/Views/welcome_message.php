...
<html>
	...
	<body>
		...
		<div class="wrap">
			...
			<div class="guide">
				<p>
                    <a href="/Cliento/index">Client</a><br>
                    <a href="/Cliento/multipart">Client multipart</a><br>
                    <a href="/Cliento/jsonRequest">Client JSON request</a><br>
                    <a href="/Cliento/xml">Client XML request</a>
                </p>
